...
<div class="full-box page-header">
            ...
            <div class="container-fluid">
                <ul class="full-box list-unstyled page-nav-tabs">
                    <li>
                        <a href="<?php SERVERURL; ?>item-new"><i class="fas fa-plus fa-fw"></i> &nbsp; AGREGAR ITEM</a>
                    </li>
                    <li>
                        <a href="<?php SERVERURL; ?>item-list"><i class="fas fa-clipboard-list fa-fw"></i> &nbsp; LISTA DE ITEMS</a>
                    </li>
                    <li>
                        <a class="active" href="<?php SERVERURL; ?>item-search"><i class="fas fa-search fa-fw"></i> &nbsp; BUSCAR ITEM</a>
                    </li>
                </ul>
            </div>
<!--CONTENT-->
        ...
        <table class="table table-dark table-sm">
            ...
            <tbody>
                <tr class="text-center" >
                    ...
                    <td>
                        <a href="<?php SERVERURL; ?>item-update" class="btn btn-success">
